...
export function Accounts() {
	...
	const { nearestGoal } = useNearestGoal();
				...
				<>
					...
					<div className="flex-1 flex flex-col justify-center mt-10 md:mt-0">
						{!nearestGoal && (
							<button
								type="button"
								className="mt-4 h-52 rounded-2xl border-2 border-dashed border-white-600 flex flex-col items-center justify-center gap-4 text-white hover:bg-teal-950/5 transition-colors"
